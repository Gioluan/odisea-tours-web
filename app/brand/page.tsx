...
const LOGOS: LogoVariant[] = [
  {
    id: "color",
    name: "Primary · Color on dark",
    description: "Default brand mark. Paper white with gold accents, designed for ink backgrounds and full-bleed photography.",
  ...
  {
    id: "color-bg",
    name: "Self-contained · Color lockup",
    description: "Carries its own dark plate. Use for social avatars, embeds, slide footers and any tight crop where the page background can't be controlled.",
  ...
  {
    id: "black",
    name: "Mono · Black on light",
    description: "Single-ink black mark for paper, white or any light background. Use for print, stamps, document headers and single-ink reproduction.",
  ...
  {
    id: "white",
    name: "Mono · White on dark",
    description: "Single-ink reverse mark, no gold. For dark photography without a clear background, video lower thirds and any one-color dark print.",
