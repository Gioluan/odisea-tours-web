...
const HOME_FAQ = [
  ...
  },
  {
    ...
    a: "Published per-traveler pricing: youth soccer tour from $1,400 for 6 to 12 nights; softball tour from $1,700 for a six-night trip; cultural tour Sabores de España €2,595; Camino de Santiago €1,995; Sin Traducción Spanish immersion for US schools $2,000 for 8 nights. Final pricing depends on group size, season and hotel level. Larger groups bring the per-traveler number down. Booking is locked in with a $500 deposit per traveler.",
  },
  {
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-10 lg:px-14 grid md:grid-cols-12 gap-8 md:gap-10 items-center">
          ...
          <div className="md:col-span-7">
            ...
            <div className="mt-6 grid grid-cols-3 gap-4 text-[0.72rem] text-ink-muted font-mono-editorial">
              ...
              <div className="border-t border-ink/15 pt-3">
                <span className="text-ink font-display text-xl block mb-1">100%</span>
                Spanish-run, on the ground
              </div>
            </div>
          </div>
        </div>
