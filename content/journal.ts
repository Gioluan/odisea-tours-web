...
export const AUTHORS: Record<AuthorId, Author> = {
  juan: {
    ...
    bio: "Founder of Odisea Tours. Has organized group sport and cultural tours across Spain since 2005.",
  },
  aitor: {
    id: "aitor",
    name: "Aitor Corres",
...
const HOWTO_BY_SLUG: Record<string, HowToData> = {
  "how-to-fundraise-for-your-teams-spain-tour": {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Spread the per-player tour cost over 10 to 12 monthly installments starting at booking. A 3,000 dollar tour becomes a 250 dollar monthly line item families can absorb. Add an early-bird discount of 5 to 10 percent for families who commit and start paying 6+ months out.",
      },
      {
  ...
  "how-to-organize-school-football-tour-spain": {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Run a minimum 1 adult to 10 pupils supervision ratio. Confirm ground coordinators are DBS-checked or equivalent, hotels have secured floors with key-card access, and a curfew walk happens at 23:00 every night. Brief the lead teacher on medical, passport and behavioral protocols before departure.",
      },
      {
      ...
      },
      {
        ...
        text: "Two friendlies per week is the right number. Three over-fatigues pupils and the second-week matches degrade. One is not enough to justify the trip. Match against organized Spanish school sides matched to your age and level.",
      },
      {
  ...
  "how-to-plan-a-group-trip-to-spain": {
    ...
    description:
      "Five operating rules for planning a group trip to Spain that keep 20 plus travelers happy without diluting the experience.",
    totalTime: "P4M",
    steps: [
      {
      ...
      },
      {
        ...
        text: "Travelers remember the dinner on the terrace with the guitar player and forget the mid-range rental car. Book the rental car on a budget and the terrace dinner without apology. Allocate the budget to the moments that will outlive the trip.",
      },
      {
      ...
      },
      {
        ...
        text: "Every trip has at least one thing that goes sideways. Flight delays, sick travelers, closed restaurants. The measure of a group travel operator is what happens at 2am on the day that did not go to plan. Choose accordingly.",
      },
    ],
  },
  "pre-tour-checklist-coach-field-guide": {
    name: "Pre-tour checklist for coaches traveling to Spain",
    description:
...
export const PILLAR_BY_CLUSTER: Record<ClusterId, PillarInfo | null> = {
  ...
  schools: {
    ...
    blurb:
      "The full picture of how we build an educational trip to Spain, the language immersion and Modern Languages programs, the academic and cultural routes, how supervision actually works day to day and what it costs per student, lives on our school trips pillar guide.",
  ...
  dmc: {
    ...
    blurb:
      "If you are an agency or tour operator rather than an end client, the B2B side of what we do, full ground handling, net rates, the four program types we operate and how to send us a brief, lives on our Spain DMC page.",
...
export const POSTS: Post[] = [
  {
    slug: "costa-brava-the-coast-most-soccer-tours-skip",
    title: "The Costa Brava: The Coast Most Soccer Tours",
    italicTitle: "Skip",
    excerpt:
      "Almost every US team that tours Catalonia sees Barcelona and nothing else. Ninety minutes north there is a coast with walled medieval towns, a village you should arrive at by boat, and the strangest building in Spain. Here is what is actually up there, and the logistics that decide whether it works.",
    date: "2026-07-30",
    readTime: "8 min",
    category: "Field Notes",
    cover: "/photos/spain-soccer-tour-costa-brava-cadaques.jpg",
    author: "juan",
    tags: ["Costa Brava", "Barcelona", "Catalonia", "Cadaques", "Tossa de Mar", "Besalu", "Girona", "Figueres", "Dali", "youth soccer", "Spain", "tour planning", "FC Barcelona"],
    faqs: [
      {
        q: "Where is the Costa Brava and how far is it from Barcelona?",
        a: "The Costa Brava is the stretch of Catalan coast running north from Blanes to the French border, in the province of Girona. Tossa de Mar, the southern end, is about an hour and twenty minutes by coach from Barcelona. Roses and Cadaqués, at the northern end, are around two hours. That makes it close enough to add to a Barcelona soccer tour as a second base rather than a day trip.",
      },
      {
        q: "What is worth seeing on the Costa Brava with a youth team?",
        a: "Four things carry a group. Tossa de Mar has the Vila Vella, the only walled medieval town left standing on the Catalan coast, with the beach directly below the ramparts. Cadaqués is a whitewashed village stacked around a church on a headland, best reached by boat around the cliffs of Cap de Creus. Figueres holds the Dalí Theatre-Museum, which the painter designed himself and is buried under. Besalú is a Romanesque town entered on foot over a fortified twelfth-century bridge. Girona, slightly inland, adds the cathedral steps and the coloured houses over the Onyar.",
      },
      {
        q: "Should a group stay in Cadaqués itself?",
        a: "Usually not. Cadaqués is beautiful but the road in is a winding mountain pass, the village core is closed to large coaches, and its two hotels together hold fewer rooms than a single large hotel in Roses. For a squad travelling with families you want a base with enough rooms to release a block in summer, which in practice means Roses. Then you visit Cadaqués by boat, which is the better arrival anyway.",
      },
      {
        q: "What is the catch with flying home from the Costa Brava?",
        a: "The departure transfer. From Roses back to Barcelona-El Prat is close to two hours, which means a dawn start with tired players and luggage at the end of a long tour. The fix is to spend the last night back on the Barcelona coast at Castelldefels, twenty minutes from the terminal, and break the drive south with a stop in Girona so the transfer day still earns its place.",
      },
      {
        q: "When is the best time to take a team to the Costa Brava?",
        a: "Late June through early August is the main window for US and Australian clubs, and the coast is at its best then. It is also the most expensive and most crowded stretch of the Spanish year, so hotel blocks need holding eight to ten months out. Spring, around Easter, is quieter and cheaper, and lines up with tournaments on the Costa Brava, though the sea is cold for swimming.",
      },
    ],
    body: [
      "Most US teams that come to Catalonia see Barcelona and go home. That is understandable. Camp Nou is there, the training complexes are there, the flights land there. But it means groups fly eight hours to Spain and never travel the ninety minutes north to the part of Catalonia that Catalans actually go to on holiday.",
      "We have been adding the Costa Brava to Barcelona programs for a while now, and it changes what the trip is. The soccer half stays the soccer half. The other half stops being a stadium tour and a shopping street and becomes something the families still talk about a year later. Here is what is genuinely up there, and, more usefully, the logistics that decide whether it works.",
      "## Where the Costa Brava actually is",
      "It is the coast running north from Blanes to the French border, in the province of Girona. The name is not a marketing invention, it dates to 1908 and means the rugged coast, which is exactly right: pine and rock and small coves rather than the long flat beaches further south.",
      "The distances matter more than the map suggests. Tossa de Mar, at the southern end, is about an hour and twenty from Barcelona. Roses and Cadaqués, at the far north, are around two hours. Girona sits inland, roughly in the middle, an hour from Barcelona and fifty minutes from either coast. Everything is close enough to work as a second base for a group and too far to do properly as day trips out of Barcelona.",
      "![Cadaqués on the Costa Brava, the whitewashed old town stacked around its church above the bay](/photos/spain-soccer-tour-costa-brava-cadaques.jpg)",
      "## The four things worth building a leg around",
      "**Tossa de Mar.** The Vila Vella is the only walled medieval town still standing on the Catalan coast. Three towers, a curtain wall, and the beach directly underneath it, so a group can walk the ramparts and then swim without moving the coach. It also sits on the road north out of Barcelona, which makes it the natural place to break a transfer day rather than a separate excursion.",
      "**Cadaqués.** Whitewashed, stacked around a church on a headland, and deliberately hard to reach. Dalí lived next door at Portlligat and the house is still there on the water. The village is the single best photograph of the trip, and the way to arrive is by boat around the cliffs of Cap de Creus rather than over the pass by road.",
      "**Figueres.** The Dalí Theatre-Museum is the strangest building in Spain: red walls studded with bread rolls, giant eggs along the roofline, a geodesic dome, and the painter buried in a crypt underneath. It handles school and youth groups easily, which not everything in this part of Spain does.",
      "**Besalú.** A Romanesque town that never modernised. You walk in over a fortified twelfth-century bridge with a gate tower in the middle of it, into streets that have not changed shape in eight hundred years. Twenty-five minutes from Figueres, so the two pair naturally into one inland day.",
      "Girona is the fifth, slightly apart because it is inland and on the road home rather than on the coast. Cathedral steps, the coloured houses stacked over the Onyar, and one of the best-preserved Jewish quarters in Europe.",
      "![The fortified Romanesque bridge at Besalú and the medieval town behind it](/photos/spain-soccer-tour-costa-brava-besalu.jpg)",
      "## The logistics that actually decide it",
      "This is the part nobody puts in a brochure, and it is what makes the difference between a leg that works and one that eats two days in a coach.",
      "**Do not base in Cadaqués.** It is the obvious instinct and it is wrong. The road in is a winding mountain pass, the village core is closed to large coaches so a fifty-seater parks outside and stays outside, and the two hotels there together hold fewer rooms than one large hotel in Roses. For a squad travelling with families, base in Roses and visit Cadaqués by boat. You get the better arrival and a hotel that can actually release twenty-five rooms in July.",
      "**Put the medieval towns inland on one day.** Besalú and Figueres are fifty and thirty minutes from Roses respectively, and twenty-five minutes from each other. Done together they are a comfortable day. Done separately they are two half-wasted ones.",
      "**Break the transfer days with the sightseeing.** Tossa on the way up and Girona on the way down means both long drives become days with something in them. Neither costs an extra night.",
      "**Book absurdly early for summer.** The first weeks of August are the most expensive and tightest of the Spanish year on this coast, and the large hotels are largely committed to European tour operators. A group needing twenty-five rooms should be holding them eight to ten months out, not four.",
      "## The departure-day trap",
      "Here is the mistake that is easy to make and annoying to fix afterwards.",
      "If your last night is on the Costa Brava, your departure transfer to Barcelona-El Prat is close to two hours. On paper that is fine. In practice it means waking a squad of teenagers and their families at five in the morning, loading a coach in the dark, and finishing a good tour with its worst day.",
      "The fix costs one night and is worth every euro of it. Come back down the coast the day before, break the drive with a couple of hours in Girona, and sleep the last night at Castelldefels on the Barcelona coast, twenty minutes from the terminal. Departure morning becomes breakfast, a group photo and a short hop. The last thing anyone remembers is the farewell dinner rather than the coach.",
      "![The coloured houses along the Onyar river in Girona with the cathedral bell tower behind](/photos/spain-soccer-tour-costa-brava-girona.jpg)",
      "## How it fits around the soccer",
      "None of this replaces the football. On the program we run it, the training sits in the Barcelona half at the front: two sessions with FC Barcelona coaching staff at the Joan Gamper complex, a Spotify Camp Nou tour for players and families, and a competitive game against Spanish opposition in the evening. Those are organized training experiences booked through the club rather than any claim of partnership, and they are confirmed in writing before the group leaves home.",
      "The Costa Brava then comes second, which is the right order for two reasons. The legs are fresh for the sessions and the game, and the coast works as the wind-down rather than the warm-up. Players who have just played a proper match in front of their families are in a very different mood swimming off the coves at Cadaqués than they would have been on day two.",
      "One practical note for coaches: late July and early August is holiday season for Catalan youth clubs, so a competitive fixture in that window has to be arranged with a club that keeps an active summer squad. It is very doable, but it is not automatic, and anyone who promises you an opponent in the first week of August without naming them is guessing.",
      "## Is it worth the extra nights?",
      "Honestly, it depends who is travelling. A squad flying in for a tournament with no family group and a tight budget should stay in Barcelona and spend the money on football.",
      "But most US and Australian clubs that come to Spain bring parents and siblings, and that group has a different problem: the players have a great week and the families have a fine one. The Costa Brava is what closes that gap. It is the half of the trip the parents choose to come back for, and in our experience it is a large part of why a club that tours once tours again.",
      "If you want to see how it looks as a full itinerary, the day-by-day is on the [Barcelona and the Costa Brava tour page](/tours/barcelona-costa-brava-soccer-tour). For the broader picture of what a Spain trip involves, start with [soccer tours in Spain](/soccer-tours-spain), and if you are weighing dates, [the best time of year for a youth soccer tour to Spain](/journal/best-time-of-year-for-a-youth-soccer-tour-to-spain) is the companion piece. When you want real numbers for your group, [start the conversation here](/plan-your-tour).",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "We deliberately schedule the Bernabéu stadium visit for Day 3 and not Day 1. The reason matters. A stadium tour on Day 1 lands as a sightseeing visit, the same way it would for a tourist family on a city break. A stadium tour on Day 3, after a real training session in a real federation environment, lands as part of the soccer story the group is now living inside. The Bernabéu is the most ambitious stadium build in world soccer, the rebuilt version with the retractable roof, the liftable pitch, and the golden skin that changes color in the afternoon light. The full guided tour takes ninety minutes, includes the changing rooms, the tunnel, the bench, the pitchside, the trophy room with the fifteen Champions League trophies, the press room where every televised post-match interview happens, and the museum, which is the single best soccer museum in Europe.",
      "We book the tour for late morning, when the angle of the light through the glass facade is strongest and the crowds are still thin. Players take photos at the bench, sit in the press room and pretend to take questions, stand in the tunnel and feel the floor vibrate underneath them. The trip leader has done this tour ninety times and still notices the moment a fifteen-year-old realizes what they are standing in. Lunch is at a restaurant in the Chamartín neighborhood ten minutes from the stadium, where we have a private room reserved that holds thirty without anyone having to shout. The afternoon is free time on the Gran Vía and at Puerta del Sol, in supervised small groups with a meeting time and a meeting point. Some players buy a Real Madrid shirt. Some players buy nothing. By 20:00 the whole group is back at the hotel. Dinner that night is at a tablao in the Madrid center, a traditional flamenco dinner show that the adults love and the players grudgingly admit was better than they expected. Back to the hotel by 23:00. Tomorrow is match day.",
      "## Day 4 · Match day in Madrid",
      "Match day in Madrid is the first competitive moment of the tour, and we treat it the way we would treat a regional semi-final at home. The opposition is confirmed in writing two months before the group arrives. For a U16 team from the West Coast on a development tour, the opponent might be the U17 side of a Tercera RFEF club from the Madrid region, an organized, properly coached youth team one tier below the professional pyramid, competitive without being humiliating. For a U14 team from a private school in Texas, it might be the U15 side of a Segunda RFEF affiliate. We name the club. We confirm the age group. We pick the right tier. The matches are played on real grass, with Spanish federation referees, on a Wednesday or Thursday evening between 17:00 and 19:00, which avoids the worst of the heat in summer and gives us match-quality light all year.",
  ...
  },
  {
    ...
    body: [
      ...
      "Beyond Camp Nou, Barcelona offers football experiences that most itineraries overlook. The Montjuic Olympic Stadium, built for the 1992 Games, is a stunning venue that hosted the opening ceremony and still operates as a professional ground. It is where Espanyol played for several years, and the hilltop setting offers panoramic views over the entire city and the sea. Espanyol's current home, the RCDE Stadium in Cornella, is a modern, intimate ground that offers excellent group access and a friendlier, less corporate atmosphere than the bigger clubs. For groups interested in futsal, one of our favorite hidden gems is attending an FCB Futsal match at the Palau Blaugrana, the arena that sits right next to Camp Nou. The quality of play is breathtaking, the tickets are affordable, the atmosphere is intense, and your players will leave with a completely different understanding of close-quarters football. We recommend it to every group that asks us for something beyond the obvious.",
      "## The city beyond the football",
      "The city itself is the other half of the equation, and it is the reason Barcelona works so well for groups that include families, partners, or non-footballing travelers. The Gothic Quarter is a maze of medieval streets that opens into hidden plazas with guitar players and outdoor cafes. La Rambla runs from Placa Catalunya down to the port and is best walked early in the morning before the crowds build. Barceloneta beach is a fifteen-minute walk from the city center and offers a full afternoon of sand, seafood restaurants, and the kind of low-effort recovery time that a group needs after three days of matches and stadium visits. The Sagrada Familia is unlike any building most visitors have ever seen, and the interior, flooded with colored light from Gaudi's stained glass, tends to silence even the loudest group of teenagers. For groups with a [youth football focus](/youth), we build itineraries that alternate football mornings with cultural afternoons, and the feedback is consistently that Barcelona makes the balance effortless.",
      "## When to go and how to arrive",
      "The best time to visit Barcelona for a football tour is October through November or March through May. The weather in these windows sits comfortably in the low twenties Celsius, the hotel rates are significantly lower than summer, and the football calendar is in full swing. Summer tours are possible and we run plenty of them, but July and August bring heat that makes afternoon training sessions punishing, crowds that make stadium visits slower, and hotel prices that climb steeply. For groups arriving from the United States or Australia, a direct flight into Barcelona El Prat drops you twenty minutes from the city center, and the airport transfer is one of the smoothest in Europe. We handle all ground logistics from the moment the group lands, including hotel check-in coordination, bus transfers, and restaurant bookings for groups of any size.",
      "## Where to stay",
      "Where to stay depends on the group's priorities. For football-first itineraries, we book hotels near the Joan Gamper training complex or in the Sants district, which sits close to Camp Nou and has excellent metro connections to the rest of the city. For groups that want to be in the center of things, the Eixample neighborhood offers wide boulevards, easy walking to the Gothic Quarter, and a huge range of restaurants that can seat large groups without advance drama. For budget-conscious clubs, the Poble Nou district near the beach has newer hotels at lower rates and a creative, local atmosphere that feels nothing like a tourist zone. Whatever the group profile, Barcelona has the accommodation and the infrastructure to handle it. If you are considering Barcelona for your next football tour, [get in touch through our planning page](/plan-your-tour) and we will build an itinerary that makes the most of every day in this city.",
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "Do you organize friendly matches against Spanish teams?",
        a: "Yes. Every youth tour includes 2 friendly matches against organized Spanish opposition matched to your age and level. We do not over-schedule matches because tired legs do not learn. Fixtures are typically against academy youth sides, top amateur clubs and federation development sides depending on the level of your group.",
      },
      {
      ...
      },
      {
        ...
        a: "Accommodation, all meals on training and match days, ground transport (private buses), training facility hire, Spanish coaching, stadium visits, match fees, referees, and our on-the-ground bilingual team for the entire tour. Excluded: international flights, travel insurance (mandatory, and arranged by the club or the family), personal spending money (we suggest 50 to 100 euros per player), and any optional excursions you add later.",
      },
      {
  ...
  },
  {
    ...
    body: [
      ...
      "The groups who book the Camino with us are more varied than you might expect. Corporate teams use it as a leadership retreat, and the conversations that happen between kilometer markers eight and fifteen of a long walking day are worth more than any offsite workshop. Friend groups in their forties and fifties use it to mark a milestone, a collective fiftieth birthday, a reunion after years apart. Church groups use it as a pilgrimage in the original sense, and the arrival at the Cathedral carries a spiritual weight that the secular groups feel too, even if they would not use that word. Families use it to do something together that is not a beach holiday, something that requires effort and delivers a payoff that everyone shares equally. If your group is also interested in the culinary side of Spain, the Camino pairs beautifully with a few days on the [Sabores de Espana tour](/tours/sabores-de-espana), and we often build combined itineraries for groups who want both.",
      "## Arriving in Santiago",
      "The arrival in Santiago is the moment the whole tour builds toward, and it is the moment we have watched hundreds of times without it losing any of its force. The group walks the last two kilometers through the outskirts of the city, enters the old town through a stone archway, follows the narrow streets downhill, and emerges into the Praza do Obradoiro with the Cathedral filling the entire western side of the square. People stop. Some cheer. Some go quiet. Some cry openly. The Cathedral has been receiving pilgrims since the ninth century, and the weight of that continuity is something you feel in your chest, not your head. After the square, we go to the Pilgrim Office to collect the Compostela certificates, and then to a long celebratory lunch where the Albarino wine flows and the stories from the trail start to become the stories the group will tell for the rest of their lives. If you are considering this for your group, [start the conversation](/plan-your-tour). The best windows are spring and autumn, and the most popular dates fill early.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "For summer there are two more we build around. The Iber Cup on the Costa del Sol in Andalusia pairs international youth football with a warm-weather beach base in the south. The Costa Daurada Cup in Salou is resort-based with full board, runs group stage through finals, and has PortAventura next door, which makes it the most family-friendly option and a strong pick for younger squads traveling with a lot of parents and siblings.",
  ...
  },
  {
    ...
    body: [
      ...
      "The single decision that shapes this whole tour is that it runs one way. The group flies into Barcelona and out of Bilbao, and the coach only ever moves in one direction. That sounds like a small thing. It is not. On a tour that starts and ends in the same city, you either backtrack at the end, which burns most of a day on a motorway you have already seen, or you build a loop that compromises the middle. Flying into Barcelona and out of Bilbao removes that problem entirely. Every kilometer the coach drives is a kilometer toward somewhere new, and the day we would have spent driving back to the start becomes an extra day on the Basque coast instead. Open-jaw flights into Barcelona and out of Bilbao are widely available from the US, usually for little or no more than a round trip, and the trade is well worth it.",
    ...
    faqs: [
      {
        ...
        a: "Odisea Tours organizes educational school trips to Spain for US private and independent schools, and has done since 2005. We are the Spanish ground operator, so we build and run the program rather than reselling it: language immersion, Modern Languages and academic itineraries, partner-school visits, guided cultural days in Madrid, Barcelona, Valencia, Sevilla and Granada, hotels, ground transport and bilingual staff traveling with the group throughout.",
      },
      {
        q: "What does a Spanish language immersion trip for a school group involve?",
        a: "A typical immersion week runs morning classes with qualified Spanish teachers, with students grouped by level on arrival, then afternoons applying the language in the city: market visits with set tasks, cooking or craft workshops in Spanish, guided cultural visits and conversation with local students. Programs run in Valencia, Madrid and the Salamanca region, from a few days up to two weeks.",
      },
      {
        q: "How much does a school trip to Spain cost per student?",
        a: "Ground-service pricing starts from around $1,400 per student for a seven-day program, based on a group of 20 sharing, with international flights quoted separately. That covers accommodation, ground transport in Spain, the guided and academic program and bilingual supervision. Travel insurance is not included: it is mandatory and arranged by the school or the families. Teacher places are free at standard ratios.",
      },
      {
        q: "How far ahead should a school book a trip to Spain?",
        a: "Six to nine months for a spring or summer departure. Schools need time for the approval process and for families to pay across installments, and the best hotel and teaching availability in peak season goes early. Autumn and winter departures can be arranged at shorter notice and cost noticeably less.",
      },
    ],
    body: [
      ...
      "Our role on an exchange is to carry the Spanish half: the partner school, the meeting program, the transport, the supervision and the cultural days built around the academic contact time, so the visiting staff manage their own students and nothing else. It is less glamorous than the immersion week and it produces the strongest results, because the relationships outlast the trip.",
      "## What it costs and how the money is usually found",
      "Ground-service pricing for a school group starts from around $1,400 per student for a seven-day program, based on a group of 20 sharing, with international flights quoted separately. That figure covers accommodation, all ground transport inside Spain, the guided and academic program and bilingual supervision. Travel insurance is not included: it is mandatory and arranged by the school or the families. Teacher places are free at standard ratios. It moves with the number of nights, the group size, the season, the hotel category and how much classroom time the school wants.",
      "Two practical notes. First, quote per student and write the inclusions out, because the letter that goes home to parents should not need a footnote. Second, autumn and winter departures cost noticeably less than June and July for the same program, and for a language trip they are arguably better, since the cities are not full and Spanish schools are in session and therefore available for contact.",
      "## How to start",
      "Six to nine months ahead for a spring or summer trip. Schools need the runway for the approval process and families need to pay across installments. Tell us the year group, the travel window, the numbers and what your department needs the trip to deliver, and we will build the program against it and send it back with the per-student cost and the inclusions written out.",
  ...
  },
  {
    ...
    italicTitle: "Agency",
    excerpt:
      "The unglamorous half of a Spain group program, sourcing, contracting, operating and being physically present when it goes wrong, explained from the ground operator's side of the desk for agencies weighing whether to run Spain directly.",
    date: "2026-07-27",
    readTime: "9 min",
    category: "Field Notes",
    ...
    faqs: [
      ...
      {
        q: "Which Spain DMC handles both sports groups and cultural programs?",
        a: "Odisea Tours handles both. On the sport side we arrange training sessions with professional-club coaches, competitive games against Spanish opposition, tournament registration and stadium visits. On the cultural side we run guided art, history and gastronomy programs across Madrid, Barcelona, Valencia, Sevilla and Granada. A mixed itinerary comes from one team on one contract.",
      },
      {
        q: "Do Spanish DMCs work with small group departures?",
        a: "Many will not quote seriously below a threshold. Odisea Tours works with groups from around 15 travelers upward, so an agency testing a new Spain program does not have to promise volume before getting a proper quote. There is no minimum volume commitment and no exclusivity requirement.",
      },
    ],
    body: [
      ...
      "Ask whether they contract directly or broker to another operator, because a chain with two links has two places to fail and only one of them will answer your call. Ask what they specialize in, since most Spanish DMCs do culture or sport but not both, and a mixed group split across two suppliers who have never spoken becomes your problem to coordinate. Ask their minimum group size, because plenty will not quote a small departure seriously and you cannot build a new program without a first small one. Ask who your named contact is and whether it stays the same, since a rotating queue means re-explaining the file every time.",
      ...
      "## Where we fit",
      "Odisea Tours has operated as a Spanish receptive operator since 2005, working B2B with agencies, tour operators and associations in North America, Britain and Australia. We cover sports, school, cultural and incentive groups, which is the unusual part: it means a mixed program comes from one team on one contract. We quote net, we stay behind your brand where you want it that way, we work from around 15 travelers upward, and there is no minimum volume or exclusivity requirement.",
