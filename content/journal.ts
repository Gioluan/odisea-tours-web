...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      "The teams that come to us are mostly the same shape. Twelve to twenty-five players, two or three coaches, a handful of parents, an age somewhere between U13 and U19. About seventy percent of our groups are from the United States and Australia. They arrive with three things already decided, how many days they have, how much they can spend, and whether they want to see Madrid or Barcelona first, and almost nothing else. Everything after that is ours to build.",
  ...
  },
  {
    ...
    body: [
      ...
      "The single most common mistake we see new tour operators make is stringing three academy visits into the same week. It looks comprehensive on a spreadsheet. In practice, by the third academy, the players stop paying attention. Two academies per tour is the correct number. One is the emotional highlight. The second is the comparison point that teaches the coaches something. Any more and you are trading the thing the players will remember for a bullet point on a brochure.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "The quiet third option we recommend more often than people expect is to visit both. Most tours try to combine a Madrid week and a Barcelona week, and groups that do this usually come home saying the comparison was the most valuable part of the trip. The players see two clubs that have won more between them than anyone else, and they see two completely different philosophies about what a football club is supposed to be. That single comparison, made in person, teaches a lesson that no film session at home can replicate.",
  ...
  },
  {
    ...
    body: [
      ...
      "The key to a great stadium visit is timing and logistics. At Odisea Tours, we handle all the bookings, transfers, and scheduling so your group arrives at the right time, avoids the crowds, and gets the most out of every visit. After 20 years and hundreds of tours, we know exactly how to sequence these visits into an itinerary that flows naturally and keeps energy levels high.",
    ],
  },
  {
    ...
    body: [
      ...
      "Our rule is two friendlies per week, not more. Three matches in seven days is physically possible but mentally saturating. Two matches, spaced three or four days apart, with a full training session in between, is the rhythm that leaves players still excited for the second game. Groups who insist on three matches usually come back to us on their next tour and ask us to cut it to two. We quietly say yes.",
